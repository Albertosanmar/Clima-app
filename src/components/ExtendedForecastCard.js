...
const ExtendedForecastCard = ({ forecast, showData }) => {
    ...
    if (showData) {
        ...
        forecastDate24 = forecast.list[8].dt_txt.substring(8, 10) + '/' + forecast.list[8].dt_txt.substring(5, 7) + '/' + forecast.list[8].dt_txt.substring(0, 4) + ' ' +  forecast.list[8].dt_txt.substring(11, 13);
        forecastDate48 = forecast.list[16].dt_txt.substring(8, 10) + '/' + forecast.list[16].dt_txt.substring(5, 7) + '/' + forecast.list[16].dt_txt.substring(0, 4) + ' ' +  forecast.list[16].dt_txt.substring(11, 13);
        forecastDate72 = forecast.list[24].dt_txt.substring(8, 10) + '/' + forecast.list[24].dt_txt.substring(5, 7) + '/' + forecast.list[24].dt_txt.substring(0, 4) + ' ' +  forecast.list[24].dt_txt.substring(11, 13);
